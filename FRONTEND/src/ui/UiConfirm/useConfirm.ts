                        ...
                        h('div', {
                            ...
                            h('div', {class: 'px-6 pb-6 flex gap-12'}, [
                                ...
                                this.config.showCancel && h('button', {
                                    class: 'flex-1 py-8 px-8 rounded-[12px] text-gray-7 bg-blue-3 text-white font-medium hover:bg-blue-4 active:bg-gray-1 transition-all duration-200',
                                    onClick: this.cancel
                                }, this.config.cancelText),

                                h('button', {
                                    class: [
                                        'flex-1 py-8 px-8 rounded-[12px] text-gray-7 bg-white shadow-custom font-medium hover:bg-gray-2 active:bg-gray-1 transition-all duration-200',
